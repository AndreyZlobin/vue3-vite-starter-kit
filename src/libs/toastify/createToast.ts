...
export const setupVNode = (
  ...
  if (contentType === ToastContentType.VNODE) {
    toastVNode = createVNode(Toast, setupVNodeProps(options, id, verticalOffset, close), () => [
      content,
    ]);
...
export const initializeContent = (content: ToastContent): DisplayContentObject => {
